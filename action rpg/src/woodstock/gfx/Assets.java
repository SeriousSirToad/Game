...
public class Assets {
	...
	public static final Animation pl_hz = new Animation(10, entities.getAnimation(16, 0, 16, 32, 4));
	public static final Animation pl_u = new Animation(10, entities.getAnimation(144, 0, 16, 32, 4));
	public static final Animation pl_dn = new Animation(10, entities.getAnimation(80, 0, 16, 32, 4));
